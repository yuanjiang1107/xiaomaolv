...
+(UIButton*)createAutoLayoutButton:(NSString*)title
                    ...
                    highlitedImage:(NSString*)highlitedImageKey
                      disableImage:(NSString*)disableImageKey
                            target:(id)target
                            action:(SEL)action{
    UIButton *button = [ViewCreatorHelper createButtonWithTitle:title
                                              frame:CGRectZero
                                              normaImage:normalImageKey
                                                 highlitedImage:highlitedImageKey
                                                   disableImage:disableImageKey
                                                         target:target
                                                         action:action];
                            ...
                            action:(SEL)action
{
    ...
    if (normalImageKey != nil) {
       normalImage = [UIImage imageNamed:normalImageKey];
    }

...
- (void)awakeFromNib {
    ...
    PlaceholderLabel.font=self.placeholderFont?self.placeholderFont:[UIFont systemFontOfSize:16.0];
...
-(void)layoutSubviews{
    ...
    PlaceholderLabel.frame = CGRectMake(5, 0, self.width, self.height);
}
